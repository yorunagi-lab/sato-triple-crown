import { baseballScene, animateBaseballScene } from './baseball-scenes.js?v=4';

const reducedMotion = () => matchMedia('(prefers-reduced-motion: reduce)').matches;
let serial = 0, mascotTemplate = null, metricTimer = null, stopMetricMotion = () => {};
const mascotReady = fetch('./gorilla.svg?v=4', { signal: AbortSignal.timeout(5000) })
...
export function spawnCheerGorilla() {
  ...
  pop.innerHTML = '<div class="cheer-mascot"><img src="./gorilla.svg?v=4" alt=""></div><span class="pop-word">DON!</span><i class="pop-spark spark-one"></i><i class="pop-spark spark-two"></i><i class="pop-spark spark-three"></i>';
  layer.append(pop);
