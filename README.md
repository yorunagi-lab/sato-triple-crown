...
- 打率：ヒットの瞬間を横・ホームベース後方・真上の3アングルで再生。
- 本塁打：フルスイングから打球の飛翔、スタンドへの着弾まで再生。
- 打点：足元から広がる砂煙と、ホーム到達時に飛び散る砂を伴うヘッドスライディング。

スイングは肩を固定した二関節の腕で両手をバットへ追従させます。2アングル目はホームベース後方から投手方向を見る構図です。手前中央にホームベース、画面右の左打席にゴリラ、奥にマウンドを置き、投球が手前へ来て打球が奥へ飛びます。ドラミングは上腕を固定し、肘を支点に前腕を動かします。
