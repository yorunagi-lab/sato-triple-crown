...
成績カードはタップした1枚だけが黄色になります。最初は打率を選択し、選択は同じタブ内の更新・再読込後も保持します。各カードはキーボードのEnter・Spaceでも操作できます。演出のパネル背景は透明で、キャラクターは半透明です。成績を隠す大きな塗りつぶしや背景のぼかしは使いません。

- 打率：ヒットの瞬間を横・真後ろ・真上の3アングルで再生。
- 本塁打：フルスイングから打球の飛翔、スタンドへの着弾まで再生。
- 打点：足元から広がる砂煙と、ホーム到達時に飛び散る砂を伴うヘッドスライディング。

スイングは肩を固定した二関節の腕で両手をバットへ追従させます。真後ろのアングルでは、後頭部・ハチマキの結び目・背番号が見え、打球が奥へ飛びます。ドラミングは上腕を固定し、肘を支点に前腕を動かします。
